...
namespace DuiLib {
    ...
    void CRenderEngine::DrawColor(HDC hDC, const RECT& rc, DWORD color)
    {
        ...
        graphics.FillRectangle(&brush, (INT)rc.left, (INT)rc.top, (INT)rc.right - (INT)rc.left, (INT)rc.bottom - (INT)rc.top);
    }
    ...
    void CRenderEngine::DrawRect(HDC hDC, const RECT& rc, int nSize, DWORD dwPenColor,int nStyle /*= PS_SOLID*/)
    {
        ...
        graphics.DrawRectangle(&pen, (INT)rc.left, (INT)rc.top, (INT)rc.right - (INT)rc.left - 1, (INT)rc.bottom - (INT)rc.top - 1);
#endif
    }
